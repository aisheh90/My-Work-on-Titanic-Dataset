...
This is an assignment for the Machine Learning course (CS763). The required is to apply differnt machine learning technqes on Titanic data [1]
...
'train_valid_test.ipynb', I split the train data into train and validation with 20%.
